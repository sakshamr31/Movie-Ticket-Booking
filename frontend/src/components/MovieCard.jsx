  ...
  return (
    <div className='flex flex-col justify-between p-3 bg-gray-800 rounded-2xl hover:-translate-y-1 transition duration-300 w-64'>
        ...
        <div className='flex items-center justify-between mt-4 pb-3'>
            ...
            <button 
                onClick={() => { navigate(`/movies/${movie._id}`)} }
                className='px-4 py-2 text-xs bg-yellow-400 hover:bg-amber-500 text-black transition rounded-full font-medium cursor-pointer'>
                Buy Tickets
            </button>

            <p className='flex items-center gap-1 text-sm text-gray-400 mt-1 pr-1'>
                <StarIcon className='w-4 h-4 text-gray-300 fill-red-600' />
